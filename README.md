...
- **Website**: [Health Plus](https://health-plus-pi.vercel.app/)
- **Framework**: React.js
- **Deployment**: Vercel
...
The website is deployed using Vercel and can be accessed at [https://health-plus-pi.vercel.app/](https://health-plus-pi.vercel.app/).

## Getting Started

To run the project locally:

1. Clone this repository: `git clone https://github.com/vishvas1410/HEALTH-PLUS.git`
